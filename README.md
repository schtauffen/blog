...
[github-io]: https://schtauffen.github.io/blog
[bliss-new]: https://bliss.js.org/#/?o=schtauffen&r=blog&b=main&ght
[gh-settings-pages]: https://github.com/schtauffen/blog/settings/pages
[gh-actions]: https://github.com/schtauffen/blog/actions
[content-dir]: /content/blog/
[utterances-app]: https://github.com/apps/utterances
[gh-issues]: https://github.com/schtauffen/blog/issues

## Just a few steps to **Finish Up**:

1. Enable **GitHub Pages**
   - Visit [github.com/schtauffen/blog/settings/pages][gh-settings-pages]
...
2. **Create your First Post**
   - Visit [bliss.js.org][bliss-new] to make your first post.
     - [bliss.js.org/#/?o=schtauffen&r=blog&b=main&ght][bliss-new]
3. **Enable Comments** (optional)
   - Visit [github.com/apps/utterances][utterances-app]
   - Click <kbd>Install</kbd>
   - Select <kbd>schtauffen</kbd> and <kbd>blog</kbd>
...
You can view your blog at [schtauffen.github.io/blog][github-io].

<!--
  TODO edge case:
  https://schtauffen.github.io/schtauffen.github.io/
  is actually
  https://schtauffen.github.io/
-->

## New Post

<kbd><a href="https://bliss.js.org/#/?o=schtauffen&r=blog&b=main&ght">Create New Post</a></kbd>
...
3. Clone and setup repo
   ```bash
   git clone git@github.com:schtauffen/blog
   pushd ./blog
   git submodule init
...
see if it's complete at [github.com/schtauffen/blog/actions][gh-actions].
